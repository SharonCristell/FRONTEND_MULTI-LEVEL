...
import { Form, Row, Col, Spinner, Button,
    InputGroup, FormControl, Image, Modal, Table, Alert } from 'react-bootstrap';
                ...
                <div>
                                ...
                                <Table responsive>
                                    ...
                                    <tbody>
                                        {this.state.kitInit !== undefined && 
                                            <tr>
                                                <td><Form.Text>{this.state.kitInit.name} </Form.Text></td>
                                                <td><Form.Text >$ {this.state.kitInit.price}</Form.Text></td>
                                                <td><Form.Text>0</Form.Text></td>
                                                <td><Form.Text>0</Form.Text></td>
                                            </tr>
                                        }
                                        <tr>
                                                <td><Form.Text>{this.state.description} </Form.Text>
                                                <Form.Text>Duración: {this.state.duration} </Form.Text>
                                                </td>
                                                <td><Form.Text >$ {this.state.price}</Form.Text></td>
                                                <td><Form.Text>$ {this.state.initialPrice}</Form.Text></td>
                                                <td><Form.Text>{this.state.quotes}</Form.Text></td>
                                            </tr>
                    ...
                    <div className="justify-content-between">
                        ...
                        <Row>
                            <Col sm="8">
                                <Form inline>
                                <Form.Text style={{fontSize:'14px'}}>Kit de inicio : &nbsp; </Form.Text>
                                
                                </Form>
                            </Col>

                            <Col sm="4" style={{textAlign: 'right'}}>
                                <Form.Text style={{fontSize:'14px'}}>$ {this.state.kitInit.price}</Form.Text>
                            </Col>
                        </Row>
                        <Row>
                            {/* <Col>
                            ...
                            <Col>
                                <Form inline >
                                    <Form.Check
                                        ...
                                        id='3'
                                        name="typePay"
                                        onChange={e => {this.handleRadio(e, 3)}}
                                        label='Asignar pago a socio: '
                                    />
                                </Form>   
                            </Col>
                        </Row>
                        }
                        { this.state.typePay === 3 && 
                            <div>
                                <Row>
                                    <Col>
                                        <Form inline >
                                            ...
                                            <Form.Control
                                                className="mr-sm-2 mt-2 ml-2"
                                                id="inlineFormInputName2"
                                                placeholder="Usuario"
                                                onChange={e => this.onChange(e, 'assignedUser')}
                                            />
                                                ...
                                                {this.state.assignedLoading && 
                                            <Spinner  className="ml-sm-2" animation="border" variant="secondary"></Spinner>
                                        }
                                        </Form>   
                                    </Col>
                                </Row>
                                <Row  style={{padding: 16}}>
                                    <Form inline  style={{paddingLeft: 16}}>
                                        
                                        
                                        {!this.state.assignedLoading && 
                                            <Row>
                                                <Col>
                                                    <Form.Label variant="primary">{this.state.assignedResult}</Form.Label>
                                                </Col>
                                            </Row>
