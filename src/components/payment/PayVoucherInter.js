            ...
            <div>
                ...
                <Row>
                    <Col sm={6}>
                        ...
                        <br></br>
                        <Form.Label>2003002538987</Form.Label>
                        <br></br>
                        <Form.Label><b>Código de Cuenta Interbancario(CCI): </b></Form.Label>
                        <br></br>
                        <Form.Label>00320000300253898732</Form.Label>
                    </Col>
                    <Col sm={6}>
                    <Form.Label><b>Cuenta Corriente en dólares: </b></Form.Label>
                        <br></br>
                        <Form.Label>2003002538994</Form.Label>
                        <br></br>
                        <Form.Label><b>Código de Cuenta Interbancario(CCI): </b></Form.Label>
                        <br></br>
                        <Form.Label>00320000300253899438</Form.Label>
                    </Col>
                </Row>
                <Row>
                    <Col sm={12}>
                                                ...
                                                <td>
                                                    <Form.Control as="select" 
                                                        ...
                                                        {typePays.map((item, id) => (
                                                            <option value={item.idSubTipoPago}>{item.descripcion}</option>
                                                        ))}
                                                    </Form.Control>
                                                </td>
